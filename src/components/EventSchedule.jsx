...
const EventSchedule = ({ height, name, link }) => {
  ...
  return (
    <div className="w-full mx-auto px-4 md:px-12 py-8 flex flex-col items-center border-t bg-one/10 rounded-2xl">
...
//       <div className="flex flex-wrap justify-center gap-4 my-6 bg-one/20 p-4 rounded-2xl shadow-lg backdrop-blur-sm">
//         {[
//           { key: "us", label: "United States", dateRange: "10th June 2025" },
//           { key: "eu", label: "Europe", dateRange: "11th June 2025" },
//           { key: "apac", label: "APAC", dateRange: "12th June 2025" },
//         ].map((zone) => (
//           <button
//             key={zone.key}
