...
const TrackCard = ({ title, subtitle, description, image, reverse }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`flex flex-col md:flex-row ${reverse ? 'md:flex-row-reverse' : ''} items-center gap-8 mb-12 cursor-pointer`}
    ...
    >
      ...
      >
        {/* Combined content */}
        <div className={`text-gray-800 text-lg leading-relaxed ${expanded ? '' : 'line-clamp-[5]'}`}>
          <h2 className="text-2xl md:text-3xl font-bold text-one">{title}</h2>
